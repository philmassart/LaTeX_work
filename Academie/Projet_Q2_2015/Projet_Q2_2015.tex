...
\begin{itemize}
\item binaire: \lilyTimeSignature{2}{4}, \lilyTimeSignature{3}{4}, \lilyTimeSignature{4}{4}, \lilyTimeSignature{3}{2}, etc.;
\item ternaire: \lilyTimeSignature{6}{8}, \lilyTimeSignature{9}{8}, etc.;
\item asymétrique: \lilyTimeSignature{5}{8}, \lilyTimeSignature{7}{8}, etc.
\end{itemize}

Veillez bien à ce que ces différentes métriques s'entendent: dans l'exemple ci-dessous, un accompagnement de croches groupées par 4 ne donnera pas une impression asymétrique si on l'écrit en \lilyTimeSignature{5}{8} sans le modifier:
\begin{center}
   \includegraphics{exemples/metrique_extrait.pdf}
\end{center}
...
%
%\subsection{Gamme mineure antique\label{min_ant}}\index{gamme!mineure antique}
%\begin{center}
...
%
%\subsection{Gamme mineure harmonique}\index{gamme!mineure harmonique}
%\begin{center}
...
%\end{center}
%
%\subsection{Gamme mineure mélodique}\index{gamme!mineure mélodique}
...
%\item ré: dorien
%\begin{center}
%   \includegraphics{exemples/mode_dorien.pdf}
%\end{center}
%\item mi: phrygien
%\begin{center}
%   \includegraphics{exemples/mode_phrygien.pdf}
%\end{center}
%\item fa: lydien
%\begin{center}
%   \includegraphics{exemples/mode_lydien.pdf}
%\end{center}
%\item sol: mixolydien
%\begin{center}
%   \includegraphics{exemples/mode_mixo_lydien.pdf}
%\end{center}
%\item la: éolien (correspond au mode mineur antique)
%\item si: locrien
%\begin{center}
%   \includegraphics{exemples/mode_locrien.pdf}
%\end{center}
%\end{enumerate}
%
%
...
%\begin{center}
%   \includegraphics{exemples/gamme_par_tons.pdf}
%\end{center}
%\item la gamme pentatonique
%\begin{center}
%   \includegraphics{exemples/gamme_pentatonique.pdf}
%\end{center}
%\item la gamme acoustique, beaucoup utilisée par Bartók
%\begin{center}
%   \includegraphics{exemples/gamme_acoustique.pdf}
%\end{center}
%\end{itemize}
%
%
